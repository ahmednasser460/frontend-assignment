...
public class Baharin_Page {
    ...
    public Baharin_Page(WebDriver driver) {

        this.driver= driver;
    }

    public void getLite_landingSBaharin () {

        WebElement country_Btn = driver.findElement(By.xpath("//div[@class='country-current']"));
        country_Btn.click();

        WebElement baharin_Btn = driver.findElement(By.xpath("//a[@id='bh']"));
        baharin_Btn.click();

        WebElement subscription_Type  = driver.findElement(By.xpath("//strong[@id='name-lite']"));
        this.type_Value = subscription_Type.getText();
        System.out.println("The subscription type for Baharin in the landing page is: " + type_Value);

        WebElement subscription_Price  = driver.findElement(By.xpath("//div[@id='currency-lite']"));
        this.price_Value = subscription_Price.getText().replace("BHD/month","");
        System.out.println("The subscription price for Baharin in the landing page is: " + price_Value);
        ...
        System.out.println("The subscription currency for Baharin in the landing page is: " + currency_Value);
    ...
    public void getLite_SummaryBaharin () {
        ...
        System.out.println("The subscription type for Baharin in the summary page is: " + summary_TypeValue);

        WebElement summary_SubscriptionPrice  = driver.findElement(By.xpath("//span[@id='order-tier-price']"));
        this.summary_PriceValue = summary_SubscriptionPrice.getText().replace("BHD/month","").replace(".00","");
        System.out.println("The subscription price for Baharin in the summary page is: " + summary_PriceValue);
        ...
        System.out.println("The subscription currency for Baharin in the summary page is: " + summary_CurrencyValue);
    }

    public void getClassic_landingSBaharin () {

        WebElement country_Btn = driver.findElement(By.xpath("//div[@class='country-current']"));
        country_Btn.click();

        WebElement saudi_Btn = driver.findElement(By.xpath("//a[@id='bh']"));
        saudi_Btn.click();
    ...
    public void getClassic_SummaryBaharin () {
    ...
    public void getPremium_landingBaharin () {
    ...
    public void getPremium_SummaryBaharin() {
